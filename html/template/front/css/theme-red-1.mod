...
.header {
    border-bottom: solid 3px #450D66;
}
.coming-soon .header {  
...
.sf-arrows > .sfHover > .sf-with-ul:after {
    border-top-color: #783F99;
}
.sf-arrows ul li > .sf-with-ul:focus:after,
.sf-arrows ul li:hover > .sf-with-ul:after,
.sf-arrows ul .sfHover > .sf-with-ul:after {
    border-left-color: #783F99;
}
...
@media (max-width: 991px) { 
	...
	.sf-menu > li > a:hover {
		background-color: #450D66 !important;
		color: #ffffff;
	}
	.sf-menu > li > a {
		background-color: #783F99;
...
.information-title {
    border-bottom: 3px solid #783F99
;   
	background-color: #783F99;
	color: #ffffff;
}
...
.top-bar {
    color: #ffffff;
	background-color: #450D66;
    border-bottom: 1px solid #783F99;
}
.top-bar a{
    color: #ffffff
;
...
.category_menu_search .form-control {
    border: 3px solid #783F99
;
    color: #737475;
}

.category_menu_search .form-control:focus {
    -webkit-appearance: 0px 0px 3px #783F99
;
    -webkit-box-shadow: 0px 0px 3px #783F99
;
    box-shadow:0px 0px 3px #783F99
;;
}
...
.view_select_btn > .btn-theme-transparent.active{
	background-color:transparent !important;
	border:3px solid #450D66;
}
.home_category_theme_1 {
    border-top: 2px solid #783F99;
}
...
.home_category_theme_1 .post-wrap{
    border-right: 2px solid #783F99;
}
.footer1-widgets {
	background: linear-gradient(#5959D1,#CD51FF);
}
