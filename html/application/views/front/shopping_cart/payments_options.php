...
<div class="row">
    ...
    <div class="cc-selector col-sm-3">
        ...
        <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden; height:200px; text-align:center; background:blue;" for="mastercarddd" onclick="radio_check('mastercarddd')">
               <h1 style="margin-top:50px;color:white;"><?php echo translate('wallet');  ?> : <?php echo currency($this->wallet_model->user_balance()); ?></h1>
        </label>
    </div>
    <?php
            //}
